...
module fsm ( rst, clk, proceed, comparison, enable, xsel, ysel, xld, yld );
  ...
  DFFARX1 \cState_reg[0]  ( .D(nState[0]), .CLK(clk), .RSTB(n1), .Q(cState[0]), 
        .QN(n6) );
  DFFARX1 \cState_reg[1]  ( .D(nState[1]), .CLK(clk), .RSTB(n1), .Q(cState[1]), 
        .QN(n5) );
  DFFARX1 \cState_reg[2]  ( .D(nState[2]), .CLK(clk), .RSTB(n1), .Q(cState[2]), 
        .QN(n3) );
...
module mux_0 ( rst, sLine, load, result, \output  );
  input [3:0] load;
  input [3:0] result;
  output [3:0] \output ;
  input rst, sLine;
...
module regis_0 ( rst, clk, load, \input , \output  );
  input [3:0] \input ;
  output [3:0] \output ;
  input rst, clk, load;
  wire   n1, n2, n3, n4, n5, n6;

  DFFARX1 \output_reg[3]  ( .D(n6), .CLK(clk), .RSTB(n5), .Q(\output [3]) );
  DFFARX1 \output_reg[2]  ( .D(n4), .CLK(clk), .RSTB(n5), .Q(\output [2]) );
  DFFARX1 \output_reg[1]  ( .D(n3), .CLK(clk), .RSTB(n5), .Q(\output [1]) );
  DFFARX1 \output_reg[0]  ( .D(n2), .CLK(clk), .RSTB(n5), .Q(\output [0]) );
  AO22X1 U2 ( .IN1(\output [0]), .IN2(n1), .IN3(load), .IN4(\input [0]), .Q(n2) );
  AO22X1 U3 ( .IN1(\output [1]), .IN2(n1), .IN3(\input [1]), .IN4(load), .Q(n3) );
  AO22X1 U4 ( .IN1(\output [2]), .IN2(n1), .IN3(\input [2]), .IN4(load), .Q(n4) );
  INVX0 U5 ( .INP(rst), .ZN(n5) );
  AO22X1 U6 ( .IN1(\output [3]), .IN2(n1), .IN3(\input [3]), .IN4(load), .Q(n6) );
  INVX0 U7 ( .INP(load), .ZN(n1) );
endmodule


module comparator ( rst, x, y, \output  );
  input [3:0] x;
  input [3:0] y;
  output [1:0] \output ;
  input rst;
  ...
  INVX0 U5 ( .INP(rst), .ZN(n5) );
  NOR2X0 U6 ( .IN1(rst), .IN2(n12), .QN(\output [1]) );
...
module subtractor ( rst, cmd, x, y, xout, yout );
  ...
  INVX0 U3 ( .INP(cmd[1]), .ZN(n6) );
  NOR2X0 U4 ( .IN1(n35), .IN2(cmd[1]), .QN(n20) );
  INVX0 U5 ( .INP(cmd[0]), .ZN(n7) );
  INVX0 U6 ( .INP(n35), .ZN(n5) );
  NOR2X0 U7 ( .IN1(n50), .IN2(n35), .QN(xout[0]) );
  NOR2X0 U8 ( .IN1(n47), .IN2(n35), .QN(xout[1]) );
  NAND2X1 U9 ( .IN1(n49), .IN2(n7), .QN(n48) );
  NAND2X1 U10 ( .IN1(n27), .IN2(n6), .QN(n26) );
  NAND2X1 U11 ( .IN1(n19), .IN2(n6), .QN(n18) );
  INVX0 U12 ( .INP(n45), .ZN(n10) );
  INVX0 U13 ( .INP(n29), .ZN(n11) );
  INVX0 U14 ( .INP(y[3]), .ZN(n13) );
  NOR2X0 U15 ( .IN1(n42), .IN2(n35), .QN(xout[2]) );
  NOR2X0 U16 ( .IN1(cmd[0]), .IN2(n44), .QN(n43) );
  NOR2X0 U17 ( .IN1(n36), .IN2(n35), .QN(xout[3]) );
  NAND2X1 U18 ( .IN1(n38), .IN2(n7), .QN(n37) );
  NAND2X1 U19 ( .IN1(n24), .IN2(n25), .QN(yout[2]) );
  NAND2X1 U20 ( .IN1(n16), .IN2(n17), .QN(yout[3]) );
  NAND2X1 U21 ( .IN1(n30), .IN2(n31), .QN(yout[1]) );
  NOR2X0 U22 ( .IN1(n12), .IN2(y[0]), .QN(n29) );
  INVX0 U23 ( .INP(x[1]), .ZN(n9) );
  INVX0 U24 ( .INP(x[0]), .ZN(n12) );
  NAND2X1 U25 ( .IN1(n10), .IN2(n9), .QN(n46) );
  INVX0 U26 ( .INP(y[1]), .ZN(n15) );
  NAND2X1 U27 ( .IN1(y[0]), .IN2(n12), .QN(n45) );
  NAND2X1 U28 ( .IN1(x[1]), .IN2(n29), .QN(n28) );
  INVX0 U29 ( .INP(x[2]), .ZN(n8) );
  INVX0 U30 ( .INP(y[2]), .ZN(n14) );
endmodule


module mux_1 ( rst, sLine, load, result, \output  );
  input [3:0] load;
  input [3:0] result;
  output [3:0] \output ;
  input rst, sLine;
  ...
  AO22X1 U8 ( .IN1(result[0]), .IN2(n5), .IN3(load[0]), .IN4(n4), .Q(
        \output [0]) );
  NOR2X0 U2 ( .IN1(rst), .IN2(sLine), .QN(n4) );
  NOR2X0 U3 ( .IN1(n6), .IN2(rst), .QN(n5) );
  INVX0 U4 ( .INP(sLine), .ZN(n6) );
endmodule


module regis_1 ( rst, clk, load, \input , \output  );
  input [3:0] \input ;
  output [3:0] \output ;
  input rst, clk, load;
  wire   n7, n8, n9, n10, n11, n12;

  DFFARX1 \output_reg[3]  ( .D(n7), .CLK(clk), .RSTB(n8), .Q(\output [3]) );
  DFFARX1 \output_reg[2]  ( .D(n9), .CLK(clk), .RSTB(n8), .Q(\output [2]) );
  DFFARX1 \output_reg[1]  ( .D(n10), .CLK(clk), .RSTB(n8), .Q(\output [1]) );
  DFFARX1 \output_reg[0]  ( .D(n11), .CLK(clk), .RSTB(n8), .Q(\output [0]) );
  AO22X1 U2 ( .IN1(\output [0]), .IN2(n12), .IN3(load), .IN4(\input [0]), .Q(
        n11) );
  AO22X1 U3 ( .IN1(\output [1]), .IN2(n12), .IN3(\input [1]), .IN4(load), .Q(
        n10) );
  AO22X1 U4 ( .IN1(\output [2]), .IN2(n12), .IN3(\input [2]), .IN4(load), .Q(
        n9) );
  INVX0 U5 ( .INP(rst), .ZN(n8) );
  AO22X1 U6 ( .IN1(\output [3]), .IN2(n12), .IN3(\input [3]), .IN4(load), .Q(
        n7) );
  INVX0 U7 ( .INP(load), .ZN(n12) );
endmodule


module regis_2 ( rst, clk, load, \input , \output  );
  input [3:0] \input ;
  output [3:0] \output ;
  input rst, clk, load;
  wire   n7, n8, n9, n10, n11, n12;
...
module gcd ( rst, clk, go_i, x_i, y_i, d_o );
  ...
  mux_0 X_MUX ( .rst(rst), .sLine(xsel), .load(x_i), .result(xsub), .\output (
        xmux) );
  mux_1 Y_MUX ( .rst(rst), .sLine(ysel), .load(y_i), .result(ysub), .\output (
        ymux) );
  regis_0 X_REG ( .rst(rst), .clk(clk), .load(xld), .\input (xmux), .\output (
        xreg) );
  regis_2 Y_REG ( .rst(rst), .clk(clk), .load(yld), .\input (ymux), .\output (
        yreg) );
  comparator U_COMP ( .rst(rst), .x(xreg), .y(yreg), .\output (comparison) );
  subtractor X_SUB ( .rst(rst), .cmd(comparison), .x(xreg), .y(yreg), .xout(
        xsub), .yout(ysub) );
  regis_1 OUT_REG ( .rst(rst), .clk(clk), .load(enable), .\input (xsub), 
        .\output (d_o) );
endmodule
