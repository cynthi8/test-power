...
module TOP_Decoder_inst_design ( TOP_instructions_3_, TOP_instructions_2_, 
  ...
  wire   net872, net871, net870, net869, net868, net867, net866, net865,
         net864, net863, net862, net861, net860;

  NAND2X2 u_cell_820 ( .IN1(TOP_instructions_0_), .IN2(TOP_instructions_2_), 
        .QN(net871) );
  NAND2X2 u_cell_819 ( .IN1(TOP_instructions_3_), .IN2(TOP_instructions_1_), 
        .QN(net872) );
  NOR2X2 u_cell_818 ( .IN1(net871), .IN2(net872), .QN(BYPASS) );
  INVX1 u_cell_817 ( .INP(TOP_instructions_2_), .ZN(net863) );
  INVX1 u_cell_816 ( .INP(TOP_instructions_3_), .ZN(net867) );
  NAND2X2 u_cell_815 ( .IN1(net863), .IN2(net867), .QN(net868) );
  INVX1 u_cell_814 ( .INP(TOP_instructions_0_), .ZN(net870) );
  NAND2X2 u_cell_813 ( .IN1(TOP_instructions_1_), .IN2(net870), .QN(net869) );
  NOR2X2 u_cell_812 ( .IN1(net868), .IN2(net869), .QN(CLAMP) );
  NAND2X2 u_cell_811 ( .IN1(net863), .IN2(net867), .QN(net864) );
  INVX1 u_cell_810 ( .INP(TOP_instructions_1_), .ZN(net866) );
  NAND2X2 u_cell_809 ( .IN1(TOP_instructions_0_), .IN2(net866), .QN(net865) );
  NOR2X2 u_cell_808 ( .IN1(net864), .IN2(net865), .QN(EXTEST) );
  NOR2X2 u_cell_807 ( .IN1(TOP_instructions_0_), .IN2(net863), .QN(net861) );
  NOR2X2 u_cell_806 ( .IN1(TOP_instructions_3_), .IN2(TOP_instructions_1_), 
        .QN(net862) );
  NAND2X2 u_cell_805 ( .IN1(net861), .IN2(net862), .QN(net860) );
  INVX0 u_cell_826 ( .INP(net860), .ZN(SAMPLE) );
  DELLN1X2 u_cell_825 ( .INP(SAMPLE), .Z(PRELOAD) );
endmodule


module TOP_BSR_mode_inst_design ( tck, net612, net610, TOP_inv_in, 
        TOP_instructions_3_, TOP_instructions_2_, TOP_instructions_1_, 
        TOP_instructions_0_, TOP_bypass_sel, TOP_INV_ABC_4, TOP_INV_ABC_3, 
        TOP_INV_ABC_2, TOP_INV_ABC );
  input net612, net610, TOP_inv_in, TOP_instructions_3_, TOP_instructions_2_,
         TOP_instructions_1_, TOP_instructions_0_, TOP_INV_ABC_4;
  output tck, TOP_bypass_sel, TOP_INV_ABC_3, TOP_INV_ABC_2, TOP_INV_ABC;
  wire   BYPASS, CLAMP, EXTEST, PRELOAD, SAMPLE, net648, net907, net906,
         net905, net904, net903, net902, net901, net900;

  INVX1 u_cell_841 ( .INP(EXTEST), .ZN(net906) );
  INVX1 u_cell_840 ( .INP(CLAMP), .ZN(net907) );
  NAND2X2 u_cell_839 ( .IN1(net906), .IN2(net907), .QN(TOP_INV_ABC) );
  INVX1 u_cell_838 ( .INP(net610), .ZN(net648) );
  NOR2X2 u_cell_837 ( .IN1(SAMPLE), .IN2(EXTEST), .QN(net904) );
  INVX1 u_cell_836 ( .INP(PRELOAD), .ZN(net905) );
  NAND2X2 u_cell_835 ( .IN1(net904), .IN2(net905), .QN(net901) );
  NAND2X2 u_cell_834 ( .IN1(net648), .IN2(net901), .QN(TOP_INV_ABC_2) );
  INVX1 u_cell_833 ( .INP(net901), .ZN(net902) );
  INVX1 u_cell_832 ( .INP(net612), .ZN(net903) );
  NOR2X2 u_cell_831 ( .IN1(net902), .IN2(net903), .QN(TOP_INV_ABC_3) );
  NOR2X2 u_cell_830 ( .IN1(CLAMP), .IN2(BYPASS), .QN(net900) );
  NAND2X2 u_cell_829 ( .IN1(net900), .IN2(net901), .QN(TOP_bypass_sel) );
  INVX1 u_cell_828 ( .INP(TOP_inv_in), .ZN(tck) );
...
module TOP_BSR_top_inst_design ( y_i_3_, y_i_2_, y_i_1_, y_i_0_, x_i_3_, 
        x_i_2_, x_i_1_, x_i_0_, test_so, test_si, net612, net610, go_i, d_o_3_, 
        d_o_2_, d_o_1_, d_o_0_, clk, TOP_tdi, TOP_si_15, TOP_inv_in, 
        TOP_instructions_3_, TOP_instructions_2_, TOP_instructions_1_, 
        TOP_instructions_0_, TOP_data_out_4, TOP_data_out_3, TOP_data_out_2, 
        TOP_data_out_1, TOP_data_out, TOP_data_in_9, TOP_data_in_8, 
        TOP_data_in_7, TOP_data_in_6, TOP_data_in_5, TOP_data_in_4, 
        TOP_data_in_3, TOP_data_in_2, TOP_data_in_1, TOP_data_in, 
        TOP_bypass_sel, TOP_INV_ABC_4 );
  input test_so, net612, net610, d_o_3_, d_o_2_, d_o_1_, d_o_0_, clk, TOP_tdi,
  ...
  output y_i_3_, y_i_2_, y_i_1_, y_i_0_, x_i_3_, x_i_2_, x_i_1_, x_i_0_,
         test_si, go_i, TOP_si_15, TOP_data_out_4, TOP_data_out_3,
  ...
  TOP_DW_bc_4 TOP_CLK_bsr1 ( .capture_clk(TOP_inv_in), .capture_en(
        ...
        .so(TOP_si) );
  TOP_DW_bc_2_test_0 TOP_GO_I_bsr2 ( .capture_clk(TOP_inv_in), .update_clk(tck), .capture_en(TOP_INV_ABC_2), .update_en(TOP_INV_ABC_3), .shift_dr(
  ...
  TOP_DW_bc_1_test_0 TOP_D_O_0__bsr11 ( .capture_clk(TOP_inv_in), .update_clk(
        tck), .capture_en(TOP_INV_ABC_2), .update_en(TOP_INV_ABC_3), 
        .shift_dr(TOP_INV_ABC_4), .mode(TOP_INV_ABC), .si(TOP_si_9), .data_in(
        d_o_0_), .data_out(TOP_data_out), .so(TOP_si_10) );
  ...
  TOP_DW_bc_2 TOP_TEST_SI_bsr15 ( .capture_clk(TOP_inv_in), .update_clk(tck), 
        ...
        TOP_INV_ABC_4), .mode(1'b0), .si(TOP_si_13), .data_in(TOP_data_in_9), 
        .data_out(test_si), .so(TOP_si_14) );
  TOP_DW_bc_1 TOP_TEST_SO_bsr16 ( .capture_clk(TOP_inv_in), .update_clk(tck), 
        .capture_en(TOP_INV_ABC_2), .update_en(TOP_INV_ABC_3), .shift_dr(
        TOP_INV_ABC_4), .mode(TOP_INV_ABC), .si(TOP_si_14), .data_in(test_so), 
        .data_out(TOP_data_out_4), .so(TOP_si_15) );
  TOP_BSR_mode_inst_design TOP_BSR_mode_inst ( .tck(tck), .net612(net612), 
        .net610(net610), .TOP_inv_in(TOP_inv_in), .TOP_instructions_3_(
        TOP_instructions_3_), .TOP_instructions_2_(TOP_instructions_2_), 
        .TOP_instructions_1_(TOP_instructions_1_), .TOP_instructions_0_(
        TOP_instructions_0_), .TOP_bypass_sel(TOP_bypass_sel), .TOP_INV_ABC_4(
        TOP_INV_ABC_4), .TOP_INV_ABC_3(TOP_INV_ABC_3), .TOP_INV_ABC_2(
        TOP_INV_ABC_2), .TOP_INV_ABC(TOP_INV_ABC) );
endmodule
...
module TOP ( RST, CLK, GO_I, X_I, Y_I, D_O, TEST_SI, TEST_SO, TEST_SE, TCK, 
  ...
  output TEST_SO, TDO;
  wire   go_i, clk, rst, test_si, test_se, test_so, TOP_inv_in, TOP_tdi,
         TOP_tdo, TOP_tdo_en, TOP_tms, TOP_trst_n, TOP_instructions_0_,
         TOP_instructions_1_, TOP_instructions_2_, TOP_instructions_3_,
         TOP_bypass_sel, net610, net612, TOP_INV_ABC_4, TOP_data_in,
         ...
         TOP_data_in_9, TOP_data_out_4, TOP_si_15, SYNOPSYS_UNCONNECTED_1,
  ...
  GTECH_OUTBUF U23 ( .DATA_OUT(TOP_tdo), .OE(TOP_tdo_en), .PAD_OUT(TDO) );
  gcd_bsd core ( .rst(rst), .clk(clk), .go_i(go_i), .x_i(x_i), .y_i(y_i), 
        .d_o(d_o), .test_si(test_si), .test_so(test_so), .test_se(test_se) );
  TOP_DW_tap_uc_width4_id0_idcode_opcode1_version0_part0_man_num0_sync_mode1_tst_mode1 TOP_DW_tap_inst ( 
        ...
        TOP_INV_ABC_4), .tdo(TOP_tdo), .tdo_en(TOP_tdo_en), .tap_state({
        ...
        .sync_capture_en(net610), .sync_update_dr(net612), .test(1'b0) );
  TOP_BSR_top_inst_design TOP_BSR_top_inst ( .y_i_3_(y_i[3]), .y_i_2_(y_i[2]), 
        .y_i_1_(y_i[1]), .y_i_0_(y_i[0]), .x_i_3_(x_i[3]), .x_i_2_(x_i[2]), 
        .x_i_1_(x_i[1]), .x_i_0_(x_i[0]), .test_so(test_so), .test_si(test_si), 
        .net612(net612), .net610(net610), .go_i(go_i), .d_o_3_(d_o[3]), 
        .d_o_2_(d_o[2]), .d_o_1_(d_o[1]), .d_o_0_(d_o[0]), .clk(clk), 
        .TOP_tdi(TOP_tdi), .TOP_si_15(TOP_si_15), .TOP_inv_in(TOP_inv_in), 
        .TOP_instructions_3_(TOP_instructions_3_), .TOP_instructions_2_(
        TOP_instructions_2_), .TOP_instructions_1_(TOP_instructions_1_), 
        .TOP_instructions_0_(TOP_instructions_0_), .TOP_data_out_4(
        TOP_data_out_4), .TOP_data_out_3(TOP_data_out_3), .TOP_data_out_2(
        TOP_data_out_2), .TOP_data_out_1(TOP_data_out_1), .TOP_data_out(
        TOP_data_out), .TOP_data_in_9(TOP_data_in_9), .TOP_data_in_8(
        TOP_data_in_8), .TOP_data_in_7(TOP_data_in_7), .TOP_data_in_6(
        TOP_data_in_6), .TOP_data_in_5(TOP_data_in_5), .TOP_data_in_4(
        TOP_data_in_4), .TOP_data_in_3(TOP_data_in_3), .TOP_data_in_2(
        TOP_data_in_2), .TOP_data_in_1(TOP_data_in_1), .TOP_data_in(
        TOP_data_in), .TOP_bypass_sel(TOP_bypass_sel), .TOP_INV_ABC_4(
        TOP_INV_ABC_4) );
endmodule
