...
module SNPS_CLOCK_GATE_HIGH_regis_0_2 ( CLK, EN, ENCLK );
  ...
  AND2X1 main_gate ( .IN1(net2773), .IN2(CLK), .Q(ENCLK) );
  LATCHX1 latch ( .CLK(n1), .D(EN), .Q(net2773) );
...
module regis_2 ( rst, clk, load, input0, output0 );
  ...
  SNPS_CLOCK_GATE_HIGH_regis_0_2 clk_gate_output_reg ( .CLK(clk), .EN(load), 
        .ENCLK(net2779) );
  DFFARX1 output_reg_3_ ( .D(input0[3]), .CLK(net2779), .RSTB(n1), .Q(
        output0[3]) );
  DFFARX1 output_reg_2_ ( .D(input0[2]), .CLK(net2779), .RSTB(n1), .Q(
        output0[2]) );
  DFFARX1 output_reg_1_ ( .D(input0[1]), .CLK(net2779), .RSTB(n1), .Q(
        output0[1]) );
  DFFARX1 output_reg_0_ ( .D(input0[0]), .CLK(net2779), .RSTB(n1), .Q(
        output0[0]) );
...
module SNPS_CLOCK_GATE_HIGH_regis_0_1 ( CLK, EN, ENCLK );
  ...
  AND2X1 main_gate ( .IN1(net2773), .IN2(CLK), .Q(ENCLK) );
  LATCHX1 latch ( .CLK(n2), .D(EN), .Q(net2773) );
...
module regis_1 ( rst, clk, load, input0, output0 );
  ...
  SNPS_CLOCK_GATE_HIGH_regis_0_1 clk_gate_output_reg ( .CLK(clk), .EN(load), 
        .ENCLK(net2779) );
  DFFARX1 output_reg_3_ ( .D(input0[3]), .CLK(net2779), .RSTB(n2), .Q(
        output0[3]) );
  DFFARX1 output_reg_2_ ( .D(input0[2]), .CLK(net2779), .RSTB(n2), .Q(
        output0[2]) );
  DFFARX1 output_reg_1_ ( .D(input0[1]), .CLK(net2779), .RSTB(n2), .Q(
        output0[1]) );
  DFFARX1 output_reg_0_ ( .D(input0[0]), .CLK(net2779), .RSTB(n2), .Q(
        output0[0]) );
