...
# Created by write_sdc on Thu Apr 15 22:16:51 2021
...
OUT_REG/clk_gate_output_reg/main_gate]
...
OUT_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -rise -setup 0 [get_cells                               \
Y_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -fall -setup 0 [get_cells                               \
Y_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -rise -hold 0 [get_cells                                \
Y_REG/clk_gate_output_reg/main_gate]
...
Y_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -rise -setup 0 [get_cells                               \
X_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -fall -setup 0 [get_cells                               \
X_REG/clk_gate_output_reg/main_gate]
set_clock_gating_check -rise -hold 0 [get_cells                                \
X_REG/clk_gate_output_reg/main_gate]
