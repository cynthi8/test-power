...
module comparator ( rst, x, y, output0 );
  ...
  NAND2X1 U13 ( .IN1(n23), .IN2(n19), .QN(n22) );
  NAND2X1 U14 ( .IN1(y[3]), .IN2(n7), .QN(n14) );
  INVX0 U15 ( .INP(x[0]), .ZN(n10) );
  NAND2X1 U16 ( .IN1(y[2]), .IN2(n8), .QN(n16) );
endmodule
