...
module comparator ( rst, x, y, output0 );
  ...
  output [1:0] output0;
  input rst;
  wire   N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, net2033;
  ...
  GTECH_AND2 C38 ( .A(N4), .B(N6), .Z(net2033) );
endmodule
...
module subtractor ( rst, cmd, x, y, xout, yout );
  ...
  wire   N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, N11, N12, N13, N14, N15,
         N16, N17, N18, N19, N20, N21, N22, N23, N24, N25, N26, N27, N28, N29,
         N30, N31, N32, N33, N34, N35, N36, net2061, net2062;
  ...
  GTECH_AND2 C63 ( .A(N9), .B(N12), .Z(net2061) );
  GTECH_AND2 C64 ( .A(N9), .B(N11), .Z(N17) );
  GTECH_AND2 C67 ( .A(N17), .B(N20), .Z(net2062) );
endmodule
