...
module sqrt_data_path ( num, load_data, incr_delta, find_next_sq, clk, finish, 
  ...
  wire   N0, N1, N2, N3, N4, N5, N6, N7, N9, N10, N11, N12, N13, N14, N15, N16,
         ...
         N31, \add_24_S2/carry[4] , \add_24_S2/carry[3] , n1, n2, n3, n4, n5,
  ...
  sqrt_data_path_DW01_add_0 add_25_S2 ( .A(Rn), .B({1'b0, 1'b0, N12, N13, N14, 
  ...
  XOR2X1 U33 ( .IN1(\add_24_S2/carry[4] ), .IN2(result[3]), .Q(N11) );
  AND2X1 U34 ( .IN1(result[2]), .IN2(\add_24_S2/carry[3] ), .Q(
        \add_24_S2/carry[4] ) );
  XOR2X1 U35 ( .IN1(\add_24_S2/carry[3] ), .IN2(result[2]), .Q(N10) );
  AND2X1 U36 ( .IN1(result[1]), .IN2(result[0]), .Q(\add_24_S2/carry[3] ) );
